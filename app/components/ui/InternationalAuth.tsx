...
interface InternationalAuthProps {
  onSuccess?: () => void;
  onError?: (error: string) => void;
}

export function InternationalAuth({ onSuccess, onError }: InternationalAuthProps) {
  ...
  const handleEmailAuth = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(data.message || `${mode === "login" ? "Login" : "Sign up"} failed`);
      }
